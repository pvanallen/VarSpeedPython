...
#
# Both are implemented as async iterator classes (_MoveAll, _Sequence) rather
...
# sequence_change_seq_num) are unchanged from varspeed_basic.py.
#
# Calling patterns:
#
# # Single move
...
class _Move:
  ...
  async def __anext__(self):
    ...
    if not self._ready:
      ...
      vs.ease = easing_method(start=vs.position, end=vs.new_position, duration=self._steps)
